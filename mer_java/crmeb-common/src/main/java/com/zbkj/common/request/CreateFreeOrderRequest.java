...
@ApiModel(value="CreateFreeOrderRequest对象", description="创建抽奖订单请求对象")
public class CreateFreeOrderRequest implements Serializable {
    ...
    @Valid
    private  OrderMerchantRequest  orderMerchantRequest;
